...
class NoiseReductionParameters {
  ...
  NoiseReductionParameters copyWith({
    ...
    return NoiseReductionParameters(
      ...
      contraSharpen: contraSharpen ?? this.contraSharpen,
      contraSharpenRep: contraSharpenRep ?? this.contraSharpenRep,
      mcleanStrength: mcleanStrength ?? this.mcleanStrength,
      mcleanSharp: mcleanSharp ?? this.mcleanSharp,
      mcleanRn: mcleanRn ?? this.mcleanRn,
      mcleanThsad: mcleanThsad ?? this.mcleanThsad,
      mcleanChroma: mcleanChroma ?? this.mcleanChroma,
      td2DegrainTr: td2DegrainTr ?? this.td2DegrainTr,
      td2GrainLevel: td2GrainLevel ?? this.td2GrainLevel,
      td2PostFft: td2PostFft ?? this.td2PostFft,
      td2PostSigma: td2PostSigma ?? this.td2PostSigma,
      td2PostMix: td2PostMix ?? this.td2PostMix,
      td2ChromaMotion: td2ChromaMotion ?? this.td2ChromaMotion,
    );
  }
